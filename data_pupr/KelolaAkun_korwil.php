<?php
    ...
    include "../data_pupr/fungsi.php";
        ...
        $db_pegawai = query("SELECT a.id_user, a.nip_user, a.nama_user, a.username, a.tgl_lahir_user, a.alamat_user, b.nama_akses, c.daerah_tugas FROM db_user a
                            INNER JOIN db_akses b ON a.id_akses = b.id_akses
                            INNER JOIN daerah_tugas c ON a.id_daerah = c.id_daerah WHERE a.id_akses = 2");

    ?>

<div class="container-fluid">
    <h2 align="center" class="pt-3 pb-3">Data Akun Pegawai Kordinator Wilayah</h2>
    <div class="row justify-content-center">
        <div class="col-sm-12 col-lg-12 ">
            <a href="registrasi_korwil.php" class="btn btn-primary mb-2">Registrasi Akun</a>
            ...
            <table class="table table-striped table-hover table-bordered table-align-middle" id="data">
                ...
                <tr align="center">
                    ...
                    <td>
                        <div class="btn-group">
                            <a href="EditAkun_korwil.php?id=<?=$data['id_user']?>"  class="btn btn-info">Edit</a>
                            <a href="DeleteAkun_korwil.php?id=<?=$data['id_user']?>" onclick="return confirm('Apakah anda ingin menghapus data ini ?')" class="btn btn-danger">Hapus</a>
                        </div>
                    </td>
                </tr>
                    <?php } ?>
